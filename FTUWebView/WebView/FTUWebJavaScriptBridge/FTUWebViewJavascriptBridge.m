...
#import "FTUWebViewJavascriptBridge.h"
...
@implementation FTUWebViewJavascriptBridge
{
    WVJB_WEAK WVJB_WEBVIEW_TYPE *_webView;
    WVJB_WEAK id _webViewDelegate;
    long _uniqueId;
    FTUWebViewJavascriptBridgeBase *_base;
}
...
+ (void)enableLogging
{
    [FTUWebViewJavascriptBridgeBase enableLogging];
}
+ (void)setLogMaxLength:(int)length
{
    [FTUWebViewJavascriptBridgeBase setLogMaxLength:length];
}
...
+ (instancetype)bridge:(id)webView
{
    ...
    if ([webView isKindOfClass:[WKWebView class]]) {
        return (FTUWebViewJavascriptBridge *)[FTUWKWebViewJavascriptBridge bridgeForWebView:webView];
    }
#endif
    if ([webView isKindOfClass:[WVJB_WEBVIEW_TYPE class]]) {
        FTUWebViewJavascriptBridge *bridge = [[self alloc] init];
...
- (void)_platformSpecificSetup:(WVJB_WEBVIEW_TYPE *)webView
{
    ...
    _base = [[FTUWebViewJavascriptBridgeBase alloc] init];
    _base.delegate = self;
}
